...
variable "aws_access_key_id" {
  default = ""                            // replace with own access key, or leave blank to use local ~/.aws credentials
}
variable "aws_secret_access_key" {
  default = ""                            // replace with own secret access key, or leaveblank to use local ~/.aws credentials
}
